...
define(function (require) {
    ...
    function save() {
        ...
        var botSelected = flows.filter(bot => bot.flowId === botRedirect)[0];

        botSelected.flowStates = botSelected.flowStates.filter(block => block.flowStateId === botRedirectBlock);
